...
const HomeScreen = ({navigation}: any) => {
  ...
  const resetSearchCoffee=()=>{
   ...
   const CoffeCardAddToCart = ({id,index,imagelink_square,name,roasted,type,prices,special_ingredient}:any) => {addToCart({id,index,imagelink_square,name,roasted,type,prices,special_ingredient});
 calculateCartPrice();
        ...
        <View style={styles.InputContainerComponent}>
          ...
          contentContainerStyle={styles.CategoryScrollViewStyle}>
            {categories.map ((data,index)=>   (
              ...
              style={styles.CategoryScrollViewContainer}>
               ...
               >
                  <Text
                    style={[styles.CategoryText, categoryIndex.index== index?{color: COLORS.primaryOrangeHex}:{}]}>{data}</Text>
          ...
          renderItem={({item})=>{
            return(
              ...
              <Text style={styles.coffe}>Coffee Beans</Text>
              <FlatList
              ref={ListRef}
          horizontal
          showsHorizontalScrollIndicator={false}
